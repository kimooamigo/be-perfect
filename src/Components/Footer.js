    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list">
          <p className="ft-list-title">خدماتنا</p>
          <ul className="ft-list-items font-section">
            <li>
              <a href="#services">رعاية الطوارئ</a>
            </li>
            <li>
              <a href="#services">أمراض القلب</a>
            </li>
            <li>
              <a href="#services">رعاية الأسنان</a>
            </li>
            <li>
              <a href="#services">الوصفات الطبية</a>
            </li>
            <li>
              <a href="#services">توجيهات للأطباء</a>
            </li>
          </ul>
        </div>
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items font-section">
            <li>
              <a href="mailto:yourname@drmhmed.com">yourname@drmhmed.com</a>
            </li>
            <li>
              <a href="mailto:yourname@drmhmed.com">yourname@drmhmed.com</a>
            </li>
